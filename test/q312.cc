...
class C : public A, B {};           // by default B is private here because class is private by default
//class C : public A, public B {};  // < fix with

struct D : private A, B {};         // by default B is public here because struct is public by default 


int main()
{
  
    cout << __cplusplus << endl;    // 199711 = C++98   WTF!?
    cout << "\n" << endl;
    ...
    D d;
    d.x = 3;      // inaccessible since private inheritance makes x private to B - compile error
                  // see below - 4 errors
...
// 
// If you have GCC 8 or 9, you’ll need to use -std=c++2a for C++20 support instead.
