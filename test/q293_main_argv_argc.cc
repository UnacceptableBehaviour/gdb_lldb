...
int main(int argc, char* argv[]) {
    std::cout << "(argv[argc] == nullptr)" << std::endl;
    std::cout << (argv[argc] == nullptr) << std::endl;      // 1
    ...
    int i=0;
    for (; i<argc; i++)
      std::cout << argv[i] << std::endl;      // 1
      
    std::cout << "\nwhile argv[i]" << std::endl;
    i=0;
    while (argv[i] != 0) {
      std::cout << argv[i] << std::endl;      // 1
      i++;
...
// You might think we access an out-of-bounds array element and the program behaviour is undefined,
// but §[basic.start.main]¶2 explicitly states:
//
// The value of argv[argc] shall be 0
//
// IE the agrv list termninator is 0
// int argc = number of arguments - 1st one is name of exe file
// argv array of arguments
// argv[argc] = 0

// OUTPUT
// ./test_c++ 45878798 87 353 4 0 6
//
// (argv[argc] == nullptr)
// 1
// 
...
// 6
// 
// while argv[i]          // while loop through args
// ./test_c++
// 45878798
// 87
// 353
