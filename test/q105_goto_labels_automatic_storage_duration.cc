...
//  A a;             // ctor called
//  if (i--)
//    goto label;    // dtor called - because jump to address before A intantiated / cted
//}
//// o/p
//// aAaA
...
label:
  if (i--) {
    cout << "=L\n";    
    goto label;     // dtor NOT called - because jump to address AFTER A intantiated / cted
  }
// dtor called on exit
cout << "=E\n";        
}
...
// §[stmt.jump]¶2 Transfer [...] back past an initialized variable with automatic storage
// duration involves the destruction of objects with automatic storage duration that are in
